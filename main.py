...
pygame.font.init()
GAME_SOUNDS = {}
GAME_SOUNDS["bg"] = pygame.mixer.Sound("assets/background.mp3")
GAME_SOUNDS["burst"] = pygame.mixer.Sound("assets/explosion.wav")
GAME_SOUNDS["shoot"] = pygame.mixer.Sound("assets/laser.wav")
GAME_SOUNDS["bg"].play(-1)
rules = "A to move left,W to move up,D to move right,Space bar too shoot"
...
def main_menu():
    ...
    while run:
        ...
        title_rules = title_font2.render(
            rules,
            1,
            (255, 255, 255),
        )
        WIN.blit(title_label, (WIDTH / 2 - title_label.get_width() / 2, 350))
        WIN.blit(title_rules, (WIDTH / 2 - title_label.get_width() / 2, 450))
        pygame.display.update()
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                run = False
